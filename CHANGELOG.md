...
### Fixed
- Reset button when the player has insurance choice.

### Changed
- Player money display animation after result display.
...
### Changed
- Display for small devices (400px).

### Fixed
- How to play: insurance translation.

## [1.4.1] - 27/08/2025

### Fixed
- Bet display when player is playing insurance.
...
### Modified
- Custom add card delay for the dealer.
- Reduced dealer's blackjack checking delay.
